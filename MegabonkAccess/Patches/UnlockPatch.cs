...
namespace MegabonkAccess
{
    ...
    public static class UnlocksFooter_OnUnlockSelected_Patch
    {
        ...
        public static void Postfix(UnlocksFooter __instance)
        {
            ...
            TolkUtil.ScheduleDelayedAction(() => ReadUnlockInfo(instanceRef));
        }

        private static void ReadUnlockInfo(UnlocksFooter instance)
        {
            ...
            try
            {
                ...
                foreach (var tmp in allTexts)
                {
                    ...
                    if (textLower == "buy" || textLower == "comprar" ||
                        textLower == "back" || textLower == "volver" ||
                        textLower == "unlock" || textLower == "desbloquear") continue;
